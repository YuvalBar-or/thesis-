...
train_data_csv = pd.read_csv(train_csv_path).drop(columns=['assessment'], errors='ignore')  # Drop assessment column
test_data_csv = pd.read_csv(test_csv_path).drop(columns=['assessment'], errors='ignore')  # Drop assessment column
...
# Exclude unnecessary columns and the assessment column
