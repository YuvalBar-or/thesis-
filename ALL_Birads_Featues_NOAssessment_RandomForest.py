...
for case_type in csv_files:
    ...
    train_data_csv = pd.read_csv(train_csv_path).drop(columns=['assessment'], errors='ignore')  # Drop assessment
    test_data_csv = pd.read_csv(test_csv_path).drop(columns=['assessment'], errors='ignore')  # Drop assessment
