...
# Columns to exclude
features_to_exclude = ['patient_id', 'pathology', 'image file path', 'cropped image file path', 'ROI mask file path', 'assessment', 'Label', 'is_train']
...
# Train a Decision Tree model with regularization
print("Training Decision Tree model with regularization...")
