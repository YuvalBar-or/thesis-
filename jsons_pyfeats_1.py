...
def extract_essential_features(image, mask, perimeter):
    features = {}
    try:
        ...
        print(f"General error in feature extraction: {e}")
...
def process_patient_row(row, is_train, abnormality_type):
    ...
    for dicom_folder_path, folder_number in matching_dirs:
        ...
        if original_image_path:
            ...
            features = extract_essential_features(image, mask, perimeter)
        else:
